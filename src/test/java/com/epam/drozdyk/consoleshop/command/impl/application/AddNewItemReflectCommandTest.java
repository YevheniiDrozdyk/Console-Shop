...
public class AddNewItemReflectCommandTest {
    private static final String BUILDER_KEY = "Guitar-ref";
    private static final String GUITAR_VENDOR_CODE = "F-300";

    @InjectMocks
    private AddNewItemReflectCommand command;
    @Mock
    ...
    public void executeWithRealInstrument() {
        ...
        final View actual = command.execute("Guitar");
